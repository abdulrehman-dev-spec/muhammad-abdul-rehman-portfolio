    ...
    <div className="app">
      ...
      <header className="navbar">
        <div className="container navbar-inner">
          <button className="brand" onClick={() => scrollToSection("home")}>
            ...
            <span className="brand-name">Muhammad Abdul Rehman</span>
          </button>
      ...
      <main>
        ...
        <section id="home" className="hero">
          <div className="container hero-grid">
            <div className="hero-content">
              ...
              <p>
                I'm Muhammad Abdul Rehman, a Full-Stack Developer from Pakistan.
                I build modern, responsive and scalable web applications that
                help businesses turn ideas into digital products.
              </p>
              ...
              <div className="hero-meta">
                ...
                <span>1+ Year Freelance Experience</span>
              </div>
            </div>
            ...
            <div className="code-card">
              ...
              <div className="code-content">
                ...
                <div className="code-indent">
                  name:{" "}
                  <span className="code-green">"Muhammad Abdul Rehman"</span>,
                </div>
                ...
                <div className="code-indent">
                  location: <span className="code-green">"Pakistan"</span>,
                </div>

                <div className="code-indent">
                  experience: <span className="code-green">"1+ year"</span>,
                </div>

                <div className="code-indent">stack: [</div>
        ...
        <section id="about" className="section">
          <div className="container about-grid">
            ...
            <div className="about-text">
              <p>
                I'm Muhammad Abdul Rehman, a Full-Stack Developer from Pakistan
                with 1+ year of freelance experience.
              </p>

              <p>
                I enjoy building complete web solutions, from polished user
                interfaces to robust APIs and database systems.
              </p>

              <p>
                My focus is clean architecture, performance, great user
        ...
        <section id="services" className="section">
          <div className="container">
            ...
            <div className="section-heading">
              ...
              <p>From your first idea to a production-ready application.</p>
            </div>
          ...
          <div className="container">
            ...
            <article className="project-card">
              ...
              <div className="project-info">
                ...
                <p>
                  A full-stack e-commerce store designed to provide customers
                  with a smooth and modern online shopping experience.
                </p>
                ...
                <div className="project-status">Full-Stack Application</div>
              </div>
            </article>
          </div>
        </section>
        ...
        <section className="container cta">
          <div className="cta-content">
            ...
            <p>
              Tell me what you're working on. Let's turn your idea into
          ...
          <div className="container contact-grid">
            <div>
              ...
              <p className="contact-description">
                Have a project, business idea or collaboration in mind? Send me
              ...
              <div className="contact-details">
                ...
                <a
                  href="https://github.com/abdulrehman-dev-spec"
                  target="_blank"
                ...
                <a
                  href="https://www.linkedin.com/in/muhammad-abdulrehman-dev/"
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  LinkedIn
      ...
      <footer>
        <div className="container footer-inner">
          <span>© {new Date().getFullYear()} Muhammad Abdul Rehman</span>

          <span>Full-Stack Developer · Pakistan</span>
        </div>
      </footer>
    </div>
  );
